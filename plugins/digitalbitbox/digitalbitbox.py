...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-Komodo-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
        msg = ('{"seed":{"source": "create", "key": "%s", "filename": "%s", "entropy": "%s"}}' % (key, filename, 'Digital Bitbox Electrum-Komodo Plugin')).encode('utf8')
