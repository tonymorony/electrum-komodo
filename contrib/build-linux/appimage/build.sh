...
(
    ...
    for i in ./locale/*; do
        dir="$PROJECT_ROOT/electrum_zcash/$i/LC_MESSAGES"
        mkdir -p $dir
...
cp "$PROJECT_ROOT/electrum-komodo.desktop" "$APPDIR/electrum-komodo.desktop"
cp "$PROJECT_ROOT/icons/electrum-komodo.png" "$APPDIR/electrum-komodo.png"
