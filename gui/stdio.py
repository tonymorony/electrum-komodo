...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Komodo address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-komodo setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-komodo setconfig' to change your settings")
        return True
